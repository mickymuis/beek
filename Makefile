...
OBJS = build/main.o build/window.o build/sampler.o build/cfifo.o build/atomq.o build/scope.o \
       ...
       build/stages/passthrough.o build/stages/lowpass.o build/stages/source.o build/stages/sink.o \
...
SOURCES = src/main.c src/window.c src/sampler.c src/cfifo.c src/atomq.c src/scope.c \
	  ...
	  src/stages/passthrough.c src/stages/lowpass.c src/stages/source.c src/stages/sink.c \
...
HEADERS = src/window.h src/sampler.h src/cfifo.h src/atomq.h src/scope.h \
	  ...
	  src/stages/passthrough.h src/stages/lowpass.h src/stages/source.h src/stages/sink.h \
